...
import * as httpStatusEnum from '../utils/enums/http-status.enum';
...
export class CategoryController {
  ...
  async getAll(request: Request, response: Response) {
    ...
    return response.status(httpStatusEnum.HttpStatus.OK).json(categories);
  }
  ...
  async create(
    ...
    return response
      .status(httpStatusEnum.HttpStatus.CREATED)
  ...
  async show(request: Request, response: Response) {
    ...
    return response.status(httpStatusEnum.HttpStatus.OK).json(category);
  }
  ...
  async update(request: Request, response: Response) {
    ...
    return response.status(httpStatusEnum.HttpStatus.NO_CONTENT).json();
  }
